...
# **Declare and Instantiate Classes** <a id="declare-and-instantiate-classes" /><Link to="../tutorials/typescript">&#8678;</Link>
...
## Class components <a id="class-components" />
...
## Full Class Example <a id="full-class-example" />
...
## Access modifiers <a id="access-modifiers" />
...
## Static Properties & Methods <a id="static-properties--methods" />
...
## Extend a class using inheritance <a id="extend-a-class-using-inheritance" />
...
## Declare an interface to ensure class shape <a id="declare-an-interface-to-ensure-class-shape" />
...
## Interfaces Design considerations <a id="interfaces-design-considerations" />

[&#9650;](#declare-and-instantiate-classes)

### When to use interfaces <a id="when-to-use-interfaces" />
...
### When to use classes <a id="when-to-use-classes" />
...
## Exercise: Imporve the Sort Class <a id="exercise-imporve-the-sort-class" />
