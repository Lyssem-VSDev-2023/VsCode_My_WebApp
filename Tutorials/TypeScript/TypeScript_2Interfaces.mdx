...
# **Interfaces in TypeScript** <a id="interfaces-in-typescript"></a><Link to="../tutorials/typescript">&#8678;</Link>
...
## The Interface <a id="the-interface"/>
...
## Using the type alias <a id="using-the-type-alias"/>
...
## Extend an interface <a id="extend-an-interface"/>
...
## Create indexable types <a id="create-indexable-types"/>
...
## Describe a JavaScript API <a id="describe-a-javascript-ap"/>
...
## Exercise: Implement Interfaces <a id="exercise-implement-interfaces"/>
