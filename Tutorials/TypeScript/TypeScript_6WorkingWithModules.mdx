...
# **Working with modules (import/export)** <a id="working-with-modules-importexport" /><Link to="../tutorials/typescript">&#8678;</Link>
...
## Organize code with modules <a id="organize-code-with-modules" />
...
## Export components: Simulation Exercise <a id="export-components-simulation-exercise" />
...
## Import a module component <a id="import-a-module-component" />
...
## Import Modules: Simulation Exercise <a id="import-modules-simulation-exercise" />
...
## Compiling the modules <a id="compiling-the-modules" />

[&#9650;](#working-with-modules-importexport)

- At runtime, the module loader locates and executes all dependencies of a module before executing it

### If compilation for use with NodeJS (console) <a id="if-compilation-for-use-with-nodejs-console" />
...
### If compilation for use in WebBrowser <a id="if-compilation-for-use-in-webbrowser" />
