...
# **Using Generics** <a id="using-generics" /><Link to="../tutorials/typescript">&#8678;</Link>
...
## Using generics <a id="using-generics-1" />
...
## Using multiple type variables <a id="using-multiple-type-variables" />
...
## Using methods and properties of a generic type <a id="using-methods-and-properties-of-a-generic-type" />
...
## Using type guards with generics <a id="using-type-guards-with-generics" />
...
## Declare a generic interface <a id="declare-a-generic-interface" />
...
## Declare a generic interface as a function type <a id="declare-a-generic-interface-as-a-function-type" />
...
## Declare a generic interface as a class type <a id="declare-a-generic-interface-as-a-class-type" />
...
## Define a generic class <a id="define-a-generic-class" />
...
## Implement generics with custom types and classes <a id="implement-generics-with-custom-types-and-classes" />
...
## Exercise: Declare a class by using a generic <a id="exercise-declare-a-class-by-using-a-generic" />
