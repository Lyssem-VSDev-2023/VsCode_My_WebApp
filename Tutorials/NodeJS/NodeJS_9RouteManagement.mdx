...
# **Route management in Node.js** <a id="route-management-in-nodejs"></a><Link to="../tutorials/nodejs">&#8678;</Link>
...
### Route parameter <a id="route-parameter" />
...
### Query parameter <a id="query-parameter" />
...
## General pattern management <a id="general-pattern-management" />
...
## Exercise - Route and query parameters <a id="exercise---route-and-query-parameters" />
...
### Implement a route to return a single product <a id="implement-a-route-to-return-a-single-product" />
...
### Implement a route to return all products <a id="implement-a-route-to-return-all-products" />
...
## Read and write <a id="read-and-write" />

[&#9650;](#route-management-in-nodejs)

- So far, you've seen examples of **requests** made toward a **web application** when the **client** wants to _read data_. However, you likely want to **write data** too.
...
### Configure your app to receive data <a id="configure-your-app-to-receive-data" />
...
### Handle the request data <a id="handle-the-request-data" />
...
## Exercise - Read and write <a id="exercise---read-and-write" />
...
### Implement reading from the API (`get`) <a id="implement-reading-from-the-api-get" />
...
### Implement writing (`post`) <a id="implement-writing-post" />
...
### Implement update data (`put`) <a id="implement-update-data-put" />
...
### Implement deleting (`delete`) <a id="implement-deleting-delete" />
...
### Implement **CRUD** <a id="implement-crud" />
