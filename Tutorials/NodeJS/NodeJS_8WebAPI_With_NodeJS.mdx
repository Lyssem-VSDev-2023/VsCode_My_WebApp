...
# **Build a web API with Node.js and Express** <a id="build-a-web-api-with-nodejs-and-express"></a><Link to="../tutorials/nodejs">&#8678;</Link>
...
## Create an Express framework web application <a id="create-an-express-framework-web-application" />
...
## HTTP module in Node.js <a id="http-module-in-nodejs" />
...
## Express framework <a id="express-framework" />
...
## Route management in Express <a id="route-management-in-express" />
...
## Serve different content types <a id="serve-different-content-types" />
...
## Exercise - Create a new Express web application <a id="exercise---create-a-new-express-web-application" />
...
### Create a basic web app with Express <a id="create-a-basic-web-app-with-express" />
...
### Create a web app that returns JSON data <a id="create-a-web-app-that-returns-json-data" />
...
## Manage a request lifecycle with middleware <a id="manage-a-request-lifecycle-with-middleware" />

[&#9650;](#build-a-web-api-with-nodejs-and-express)

### Request steps <a id="request-steps" />
...
### Request pipeline <a id="request-pipeline" />
...
## Exercise - Manage request lifecycle <a id="exercise---manage-request-lifecycle" />

[&#9650;](#build-a-web-api-with-nodejs-and-express)

### Add basic authorization to an Express framework <a id="add-basic-authorization-to-an-express-framework" />
...
### Protect the route <a id="protect-the-route" />
...
### Add authorization header <a id="add-authorization-header" />
