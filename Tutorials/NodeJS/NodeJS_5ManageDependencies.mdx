...
# **Manage Packages Dependencies** <a id="manage-packages-dependencies"></a><Link to="../tutorials/nodejs">&#8678;</Link>
...
## When to update <a id="when-to-update" />
...
## Use semantic versioning <a id="use-semantic-versioning" />
...
## Update a package by using npm <a id="update-a-package-by-using-npm" />
...
## Configure the package.json for update <a id="configure-the-packagejson-for-update" />
...
## package-lock.json <a id="package-lockjson" />
...
## Find and update outdated packages <a id="find-and-update-outdated-packages" />
...
## Manage security issues <a id="manage-security-issues" />
...
## Exercise: Manage dependency updates <a id="exercise-manage-dependency-updates" />
