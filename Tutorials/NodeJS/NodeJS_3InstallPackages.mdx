...
# **Add packages to NodeJS project** <a id="add-packages-to-nodejs-project"></a><Link to="../tutorials/nodejs">&#8678;</Link>

1. [Determine whether you need a package](#determine-whether-you-need-a-package)
1. [Evaluate a package](#evaluate-a-package)
1. [Install a package](#install-a-package)
1. [Find a package](#find-a-package)
1. [npm commands](#npm-commands)
1. [Production vs. development dependencies](#production-vs-development-dependencies)
1. [How to install a package](#how-to-install-a-package)
1. [After installation](#after-installation)
1. [Clean up dependencies](#clean-up-dependencies)
...
## Determine whether you need a package <a id="determine-whether-you-need-a-package"/>
...
## Evaluate a package <a id="evaluate-a-package"/>
...
## Install a package <a id="install-a-package"/>
...
## Find a package <a id="find-a-package"/>
...
## npm commands <a id="npm-commands"/>
...
## Production vs. development dependencies <a id="production-vs-development-dependencies"/>
...
## How to install a package <a id="how-to-install-a-package"/>
...
## After installation <a id="after-installation"/>
...
## Clean up dependencies <a id="clean-up-dependencies"/>
