...
# **Work with files and directories in NodeJS** <a id="work-with-files-and-directories-in-nodejs"></a><Link to="../tutorials/nodejs">&#8678;</Link>
...
## Include the fs module <a id="include-the-fs-module" />
...
## List contents in a directory <a id="list-contents-in-a-directory" />
...
## Determine content type <a id="determine-content-type" />
...
## Recursion through directories <a id="recursion-through-directories" />
...
## Exercise: find sales.json in the different folders <a id="exercise-find-salesjson-in-the-different-folders" />
...
## Work with file paths in Node.js <a id="work-with-file-paths-in-nodejs" />
...
### Determine the current directory <a id="determine-the-current-directory" />
...
### Work with paths <a id="work-with-paths" />
...
### Determine filename extensions <a id="determine-filename-extensions" />
...
### Parse: Get all data about a file or path <a id="parse-get-all-data-about-a-file-or-path" />
...
## Exercise: Working with paths <a id="exercise-working-with-paths" />
...
## Create files and directories <a id="create-files-and-directories" />

[&#9650;](#work-with-files-and-directories-in-nodejs)

### Create directories <a id="create-directories" />
...
### Check if directories exist <a id="check-if-directories-exist" />

[&#9650;](#work-with-files-and-directories-in-nodejs)

- `mkdir` method throws an error if a directory already exist, it is recommended to use `try/catch` when handling directories.

- const pathToCreate = path.join(\_\_dirname, "stores", "201", "newDirectory");
...
### Create files <a id="create-files" />
...
## Exercise: Create files and directories <a id="exercise-create-files-and-directories" />
...
## Read and write to files <a id="read-and-write-to-files" />

[&#9650;](#work-with-files-and-directories-in-nodejs)

### Read data from files <a id="read-data-from-files" />
...
### Parse data in files <a id="parse-data-in-files" />
...
### Write data to files <a id="write-data-to-files" />
...
- **`\r\n`** tells JavaScript to put the value on its **own line**. _(carriage return line feed)_.

## Exercise - Read and write to files <a id="exercise---read-and-write-to-files" />
