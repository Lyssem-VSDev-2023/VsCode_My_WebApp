...
# **Initialize package.json & Scripts** <a id="h"></a><Link to="../generics/vscode">&#8678;</Link>

- [Initialize a package.json](#a)
- [package.json file contents](#aa)
- [Scripts for managing your project](#aaa)
- [Script naming](#aaaa)
...
## Initialize a package.json <a id="a" />
...
## package.json file contents <a id="aa" />
...
## Scripts for managing your project <a id="aaa" />
