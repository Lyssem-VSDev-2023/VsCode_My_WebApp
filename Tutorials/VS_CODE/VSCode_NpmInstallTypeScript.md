# **VSCode Install TypeScript**

- [**VSCode Install TypeScript**](#vscode-install-typescript)
...
- Open a terminal
- Run the following npm command: ```npm install -g typescript``` (-g if for installing the package globally in the computer)
- Run the following npm command: ```npm install -g ts-node```
...
- Open a **terminal**
- Run the following npm command: ```tsc```
...
this a more elaborated list of TS compiler options
