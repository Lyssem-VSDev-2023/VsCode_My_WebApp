...
# VSCode - Install MarkdownIt <a id="h"></a><Link to="../generics/vscode">&#8678;</Link>

- [Install MarkDown Compiler](#a)
- [Automatic Markdown compilation](#aa)

## Install MarkDown Compiler <a id="a" />

[&#9650;](#h)

MarkdownIt allow the compilation of MD files and converting thm to html files
...
- Select the Default option _(continue without scanning)_ or select any other suitable option.

![MarkDown Menu](/Tutorials/VS_CODE/Images/markdwon1.png)

---

## Automatic Markdown compilation <a id="aa" />
