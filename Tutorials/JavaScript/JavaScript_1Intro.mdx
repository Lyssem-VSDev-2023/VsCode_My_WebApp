...
# **Intro to Javascript** <a id="intro-to-javascript"></a><Link to="../tutorials/javascript">&#8678;</Link>
...
## Variables Declaration <a id="variables-declaration"></a>

[&#9650;](#intro-to-javascript)

### var and let <a id="var-and-let"></a>
...
### Math operations <a id="math-operations"></a>
...
- Months and dates are 0 based indexes (0 => Jan || 0 => Monday)
...
- Date-time form: Date only followed by T followed by HH:mm, HH:mm:ss or HH:mm:ss.sss.
- For example:
